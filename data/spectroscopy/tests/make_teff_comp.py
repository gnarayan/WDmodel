...
def main():
    ...
    ax1.plot(wave, t25/bluening, color='red' ,marker=None, ls='--',label='25k K, log g=7.8, Av=0.3')
    ax1.plot(wave, t80,          color='blue',marker=None, ls='-' ,label='80k K, log g=7.8, Av=0.0')
    ax1.plot(wave, t80/bluening, color='blue',marker=None, ls='--',label='80k K, log g=7.8, Av=0.3')

    ax2.plot(wave, t25,          color='red' ,marker=None, ls='-' ,label='25k K, log g=7.8, Av=0.0')
    ax2.plot(wave, t25/bluening, color='red' ,marker=None, ls='--',label='25k K, log g=7.8, Av=0.3')
    ax2.plot(wave, t80,          color='blue',marker=None, ls='-' ,label='80k K, log g=7.8, Av=0.0')
    ax2.plot(wave, t80/bluening, color='blue',marker=None, ls='--',label='80k K, log g=7.8, Av=0.3')
    ax2.plot(wave, t25*np.mean(t80)/np.mean(t25),          color='green' ,marker=None, ls='-' ,alpha=0.6, label='25k K, log g=7.8, Av=0.0 shifted')
    ax2.plot(wave, t25/bluening*np.mean(t80)/np.mean(t25), color='green' ,marker=None, ls='--',alpha=0.6, label='25k K, log g=7.8, Av=0.3 shifted')
    ax1.set_yscale('log')
    ax2.set_yscale('log')
