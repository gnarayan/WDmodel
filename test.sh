...
mpirun -np 4 $RUNNER -m WDmodel --specfile WDmodel/tests/test.flm --ignorephot --rebin 2 --everyn 3 --nburnin 10 --nprod 50 --mpi --redo --nwalkers 100
if [ "$1" = -c ]; then
    coverage combine
fi
...
$ARUNNER -m WDmodel --specfile WDmodel/tests/test.flm --ignorephot --nprod 50 --nburnin 10 --redo --nwalkers 30 --covtype White
