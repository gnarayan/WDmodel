...
def main():
    ...
    for obj in phottable.obj:
        ...
        for specfile in specfiles:
            ...
            outlines.append("mpirun -np 32 ./fit_WDmodel.py mpil --specfile {} --trimspec 3700 5200 --covtype ExpSquared --photfile data/photometry/WDphot_C22.dat --tau=5000 --tau_fix=True --tau_bounds 1000 10000 --discard=10 --phot_dispersion 0.001 --redo".format(specfile))
    ...
    for specfile in leftfiles:
        ...
        outlines.append("#SBATCH -o {}".format(stdout_file))
        outlines.append("#SBATCH -e {}".format(stderr_file))
        outlines.append("mpirun -np 32 ./fit_WDmodel.py mpil --specfile {} --trimspec 3700 5200 --covtype ExpSquared --ignorephot --tau=5000 --tau_fix=True --tau_bounds 1000 10000 --discard=10 --redo".format(specfile))
        out = addnewlines((lines+outlines))
        with open(script_file,'w') as f:
            f.writelines(out)
