...
def main():
    ...
    for obj in phottable.obj:
        ...
        for specfile in specfiles:
            ...
            outlines.append("mpirun -np 32 ./fit_WDmodel.py --mpi --specfile {} --trimspec 3700 5200 --photfile data/photometry/WDphot_C22.dat --samptype pt --covmodel Matern32 --nprod 1000 --nwalkers 100 --phot_dispersion 0.001 --thin 10 --redo --rescale".format(specfile))
    ...
    for specfile in leftfiles:
        ...
        outlines.append("#SBATCH -o {}".format(stdout_file))
        outlines.append("#SBATCH -e {}".format(stderr_file))
        outlines.append("mpirun -np 32 ./fit_WDmodel.py --mpi --specfile {} --trimspec 3700 5200 --ignorephot --tau=5000 --redo --rescale --samptype pt --covmodel Matern32 --nprod 1000 --nwalkers 100 --thin 10 --outroot out/ignorephot".format(specfile))
        out = addnewlines((lines+outlines))
        with open(script_file,'w') as f:
            f.writelines(out)
